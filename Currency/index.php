...
<html>
    ...
    <p> This is a currency converter that is done using the programming language of php.</p>
    <p>Make sure to convert every time you can since the value changes every second that passes.</p>
    <div class ="cube">
    <div class ="main">
